...
<script>
    ...
    new Chart($grafica, {
        ...
        data: {
            ...
            datasets: [{
                data: clientesPorDepartamento.map(dato => dato.conteo), 
    ...
    new Chart($graficaEdad, {
        ...
        data: {
            ...
            datasets: [{
                data: clientesPorEdad.map(dato => dato.valor), 
    ...
    new Chart($graficaVentas, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: ventasPorMes.map(dato => dato.total), 
    ...
    new Chart($graficaClientes, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo $totalClientesUltimoAnio ?>, <?php echo $totalClientesAniosAnteriores ?>], 
