    ...
    <div class="col-4">
        <div class="card">
            <div class="card-body">
                ...
                <h1 class="card-title"><?php echo $totalVentasUltimoMes ?></h1>
    ...
    <div class="col-4">
        <div class="card">
            <div class="card-body">
                ...
                <h1 class="card-title"><?php echo $totalVentasUltimoAnio ?></h1>
...
<script>
    ...
    const datos = {
        data: [parseFloat("<?php echo $totalVentasEnOtroPeriodo ?>"), parseFloat("<?php echo $totalVentasUltimoMes ?> "), parseFloat("<?php echo $totalVentasUltimoAnio ?> ")],
